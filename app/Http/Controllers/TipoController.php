...
class TipoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tipos.index')
            ->with('success', 'El tipo de ordenadores se ha creado correctamente');
    }
    ...
    public function update(Request $request, Tipo $tipo)
    {
        ...
        return redirect()->route('tipos.index')
            ->with('success', 'El tipo de ordenadores se ha modificado correctamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('tipos.index')
            ->with('success', 'El tipo de ordenadores se ha borrado correctamente');
    }
}
